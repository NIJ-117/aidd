...
from hclcode.io import AutoCompleter, ConfirmGroup, InputOutput
from hclcode.utils import ChdirTemporaryDirectory
...
class TestInputOutput(unittest.TestCase):
    ...
    def test_get_input_is_a_directory_error(self, mock_input):
        ...
        with patch("hclcode.io.open", side_effect=IsADirectoryError):
