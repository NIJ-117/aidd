---
title: o1-preview is SOTA on the hclcode leaderboard
...
# OpenAI o1-preview is SOTA on the hclcode leaderboard
...
OpenAI o1-preview scored 79.7% on hclcode's code editing benchmark,
...
It is much more practical to use hclcode's
...
The o1-preview model had trouble conforming to hclcode's diff edit format.
The o1-mini model had trouble conforming to both the whole and diff edit formats.
hclcode is extremely permissive and tries hard to accept anything close
...
It seems likely that hclcode could optimize its prompts and edit formats to
better harness the o1 models.


## Using hclcode with o1

OpenAI's new o1 models are supported in v0.57.0 of hclcode:
...
> based on hclcode v0.56.1-dev.
> See the [hclcode leaderboards](/docs/leaderboards/) for up-to-date results
> based on the latest hclcode releases.
