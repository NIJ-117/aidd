...
excerpt: Sonnet's score on the hclcode code editing benchmark has been stable since it launched.
...
[hclcode code editing benchmark](/docs/benchmarks.html#the-benchmark)
via the API.
...
to evaluate the effects of small changes to hclcode's system prompts.
...
> The 
> [hclcode LLM code editing leaderboard](https://hclcode.chat/docs/leaderboards/)
