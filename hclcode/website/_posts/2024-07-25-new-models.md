...
[hclcode's code editing leaderboard](https://hclcode.chat/docs/leaderboards/)
...
You can code with all of these models using hclcode like this:
...
$ hclcode --model deepseek/deepseek-coder

$ export MISTRAL_API_KEY=your-key-goes-here
$ hclcode --model mistral/mistral-large-2407

$ export OPENROUTER_API_KEY=your-key-goes-here
$ hclcode --model openrouter/meta-llama/llama-3.1-405b-instruct
$ hclcode --model openrouter/meta-llama/llama-3.1-70b-instruct
$ hclcode --model openrouter/meta-llama/llama-3.1-8b-instruct
```
...
secured #7 on hclcode's leaderboard, 
...
Mistral Large 2 (2407) scored only 60% on hclcode's code editing
benchmark. 
