...
nav_order: 15
description: How to configure hclcode with a yaml config file.
---

# YAML config file

Most of hclcode's options can be set in an `.hclcode.conf.yml` file.
hclcode will look for a this file in these locations and
...
can also
[download from GitHub](https://github.com/hclcode-AI/hclcode/blob/main/hclcode/website/assets/sample.hclcode.conf.yml).

<!--[[[cog
from hclcode.args import get_sample_yaml
from pathlib import Path
text=get_sample_yaml()
Path("hclcode/website/assets/sample.hclcode.conf.yml").write_text(text)
cog.outl("```")
cog.out(text)
cog.outl("```")
]]]-->
...
#model-settings-file: .hclcode.model.settings.yml

## Specify a file with context window and costs for unknown models
#model-metadata-file: .hclcode.model.metadata.json
...
#input-history-file: .hclcode.input.history

## Specify the chat history file (default: .hclcode.chat.history.md)
#chat-history-file: .hclcode.chat.history.md
