...
parent: Usage
nav_order: 100
description: Speak with hclcode about your code!
---

# Voice-to-code with hclcode

Speak with hclcode about your code! Request new features, test cases or bug fixes using your voice and let hclcode do the work of editing the files in your local git repo. As with all of hclcode's capabilities, you can use voice-to-code with an existing repo or to start a new project.

Voice support fits quite naturally into hclcode's AI pair programming
chat interface. Now you can fluidly switch between voice and text chat
when you ask hclcode to edit your code.
...
the hclcode chat session.

See the [installation instructions](https://hclcode.chat/docs/install/optional.html#enable-voice-coding) for
...
> Commit ef9e3e7 hclcode: Add a factorial endpoint that uses math.factorial.  
