...
parent: More info
nav_order: 960
description: hclcode uses various "edit formats" to let LLMs edit source files.
---

# Edit formats

hclcode uses various "edit formats" to let LLMs edit source files.
Different models work better or worse with different edit formats.
hclcode is configured to use the optimal format for most popular, common models.
