...
[![benchmark results](/assets/benchmarks-0125.svg)](https://hclcode.chat/assets/benchmarks-0125.svg)
...
hclcode's existing
[lazy coding benchmark](https://hclcode.chat/docs/unified-diffs.html).
...
- It gets worse benchmark scores when using the [unified diffs](https://hclcode.chat/docs/unified-diffs.html) code editing format.
- Using hclcode's older SEARCH/REPLACE block editing format, the new January model outperforms the older November model. But it still performs worse than both models using unified diffs.
...
- [Code editing benchmarks for OpenAI's "1106" models](https://hclcode.chat/docs/benchmarks-1106.html).
- [hclcode's lazy coding benchmark](https://hclcode.chat/docs/unified-diffs.html).
