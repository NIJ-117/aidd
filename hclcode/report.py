...
from hclcode.urls import github_issues
from hclcode.versioncheck import VERSION_CHECK_FNAME
...
def report_github_issue(issue_text, title=None, confirm=True):
    ...
    :return: None
    """
    version_info = f"hclcode version: {__version__}\n"
    ...
    if confirm:
        ...
        print()
        print("Please consider reporting this bug to help improve hclcode!")
