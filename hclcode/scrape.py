...
from hclcode import __version__, urls, utils
from hclcode.dump import dump  # noqa: F401

hclcode_user_agent = f"hclcode/{__version__} +{urls.website}"
...
def install_playwright(io):
    ...
    pip_cmd = utils.get_pip_install(["hclcode-chat[playwright]"])
...
class Scraper:
    ...
    def scrape_with_httpx(self, url):
        ...
        headers = {"User-Agent": f"Mozilla./5.0 ({hclcode_user_agent})"}
        try:
            with httpx.Client(
