...
from hclcode import __version__
from hclcode.args_formatter import (
    DotEnvFormatter,
...
def get_parser(default_config_files, git_root):
    parser = configargparse.ArgumentParser(
        description="hclcode is AI pair programming in your terminal",
        add_config_file_help=True,
        default_config_files=default_config_files,
        config_file_parser_class=configargparse.YAMLConfigFileParser,
        auto_env_var_prefix="hclcode_",
    )
    ...
    group.add_argument(
        ...
        help="Specify a file with hclcode model settings for unknown models",
    )
    group.add_argument(
        "--model-metadata-file",
    ...
    default_input_history_file = (
        os.path.join(git_root, ".hclcode.input.history") if git_root else ".hclcode.input.history"
    )
    default_chat_history_file = (
        os.path.join(git_root, ".hclcode.chat.history.md") if git_root else ".hclcode.chat.history.md"
    )
    group.add_argument(
        "--input-history-file",
    ...
    group.add_argument(
        ...
        default=None,
        help="Log the conversation with the LLM to this file (for example, .hclcode.llm.history)",
    )
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Enable/disable adding .hclcode* to .gitignore (default: True)",
    )
    default_hclcodeignore_file = (
        os.path.join(git_root, ".hclcodeignore") if git_root else ".hclcodeignore"
    )
    group.add_argument(
        "--hclcodeignore",
        metavar="hclcodeIGNORE",
        default=default_hclcodeignore_file,
        help="Specify the hclcode ignore file (default: .hclcodeignore in git root)",
    )
    group.add_argument(
        "--subtree-only",
        action="store_true",
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Attribute hclcode code changes in the git author name (default: True)",
    )
    group.add_argument(
        "--attribute-committer",
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Attribute hclcode commits in the git committer name (default: True)",
    )
    group.add_argument(
        "--attribute-commit-message-author",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Prefix commit messages with 'hclcode: ' if hclcode authored the changes (default: False)",
    )
    group.add_argument(
        "--attribute-commit-message-committer",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Prefix all commit messages with 'hclcode: ' (default: False)",
    )
    group.add_argument(
        "--commit",
        action="store_true",
    ...
    group.add_argument(
        "--check-update",
        action=argparse.BooleanOptionalAction,
        help="Check for new hclcode versions on launch",
        default=True,
    )
    group.add_argument(
        "--install-main-branch",
    ...
    group.add_argument(
        ...
        "--update",
        action="store_true",
        help="Upgrade hclcode to the latest version from PyPI",
        default=False,
    )
    group.add_argument(
        "--apply",
    ...
    group.add_argument(
        ...
        metavar="CONFIG_FILE",
        help=(
            "Specify the config file (default: search for .hclcode.conf.yml in git root, cwd"
            " or home directory)"
        ),
    )
    group.add_argument(
        ...
        "--browser",
        action="store_true",
        help="Run hclcode in your browser",
        default=False,
    )
    group.add_argument(
