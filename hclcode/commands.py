...
from hclcode import models, prompts, voice
from hclcode.format_settings import format_settings
from hclcode.help import Help, install_help_extra
from hclcode.llm import litellm
from hclcode.repo import ANY_GIT_ERROR
from hclcode.run_cmd import run_cmd
from hclcode.scrape import Scraper, install_playwright
from hclcode.utils import is_image_file
...
class Commands:
    ...
    def cmd_undo(self, args):
        "Undo the last git commit if it was done by hclcode"
        try:
    ...
    def raw_cmd_undo(self, args):
        ...
        if last_commit_hash not in self.coder.hclcode_commit_hashes:
            self.io.tool_error("The last commit was not made by hclcode in this chat session.")
            self.io.tool_output(
    ...
    def cmd_add(self, args):
        "Add files to the chat so hclcode can edit them or review them in detail"
        ...
        for word in filenames:
            ...
            if self.coder.repo and self.coder.repo.ignored_file(fname):
                self.io.tool_warning(f"Skipping {fname} due to hclcodeignore or --subtree-only.")
                continue
    ...
    def basic_help(self):
        ...
        self.io.tool_output()
        self.io.tool_output("Use `/help <question>` to ask questions about how to use hclcode.")

    def cmd_help(self, args):
        "Ask questions about hclcode"
        ...
        user_msg += """
# Announcement lines from when this session of hclcode was launched:
...
"""
    ...
    def cmd_report(self, args):
        ...
        from hclcode.report import report_github_issue
